...
const ReactRouterRoutes = () => {
  return (
    <Routes>
      ...
      />
      <Route
        path={ROUTES.consumption.path}
        element={<AuthenticationGuard component={Consumption} />}
      />
      ...
      <Route
        ...
        element={
          <AuthenticationGuard
            component={() => <VisitsList visitListApplyFilter="allVisitsPage" />}
          />
        }
      />
      <Route
        path={ROUTES.visitDetail.path}
        element={<AuthenticationGuard component={VisitDetail} />}
      />
      <Route path={ROUTES.team.path} element={<AuthenticationGuard component={Team} />} />
      <Route
        path={ROUTES.clientDetail.path}
        element={<AuthenticationGuard component={ClientProfile} />}
      />
