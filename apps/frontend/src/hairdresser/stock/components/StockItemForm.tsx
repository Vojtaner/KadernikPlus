      ...
      {isPurchaseStockItem || isOnlyShoppingForm ? (
        <>
          ...
          <TextField
            ...
            label={
              <FormattedMessage
                id="stockItem.totalPrice"
                defaultMessage="Cena za všechna balení v Kč"
              />
            }
            type="number"
            fullWidth
          ...
          <>
            ...
            <SelectField
              ...
              label={intl.formatMessage({
                id: 'stockItem.unit',
                defaultMessage: 'Vyberte jednotku materiálu',
              })}
              control={control}
              fieldPath="unit"
            ...
            <Stack direction="row" spacing={1}>
              <TextField
                fieldPath="packageCount"
                label={
                  <FormattedMessage id="stockItem.packageCount" defaultMessage="Počet balení" />
                }
                type="number"
                required
                control={control}
              ...
              <Stack direction="column" spacing={0.5}>
                <Typography color="text.secondary" fontSize="0.8rem" paddingLeft="0.2rem">
                  ...
                  <Box
                    ...
                    color="success"
                    fontWeight="bold"
                  >{` ${Math.round(pricePerPackage)} Kč`}</Box>
                  <br />
                  <FormattedMessage
                    id="stockItem.checkQuestion"
                    defaultMessage="Je tomu přibližně tak?"
                  />
                </Typography>
              </Stack>
            ) : null}
