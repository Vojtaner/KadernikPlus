...
import ClientForm, { useClientForm } from '../Forms/ClientForm'
...
const AddEditClientFormDialog = (props: AddEditClientFormDialogProps) => {
  ...
  const intl = useIntl()
  const { control, createOrUpdateClientMutation, handleSubmit, resetClientForm } = useClientForm(defaultValues)
