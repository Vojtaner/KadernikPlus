  ...
  return (
    <Stack spacing={2} alignItems="center" justifyContent="center" minHeight="85vh" width="100%">
      <Typography variant="h4" fontWeight="bold" align="center">
        <FormattedMessage
          id="importPage.welcome"
          defaultMessage="Ušetřete si čas při startu aplikace"
        />
      </Typography>
      ...
      >
        ...
        {intl.formatMessage({
          ...
          defaultMessage:
            ' namísto ručního zadávání stovek záznamů si můžete jednorázově dokoupit funkci importu.',
        })}
      </Typography>
      ...
      <PricingCard
        ...
        features={[
          intl.formatMessage({
            id: 'pricingCard.feature1',
            defaultMessage: 'Ušetřte hodiny ručního zadávání',
          }),
          intl.formatMessage({
            id: 'pricingCard.feature2',
            defaultMessage: '800 kontaktů naimportujete během chvíle',
          }),
          intl.formatMessage({
            id: 'pricingCard.feature3',
            defaultMessage: 'Bez chybného a nudného opisování',
          }),
          intl.formatMessage({
