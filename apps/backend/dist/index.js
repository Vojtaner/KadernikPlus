...
const prisma_1 = __importDefault(
  require("./infrastructure/data/prisma/prisma")
);
const cors_1 = __importDefault(require("cors"));
const express_oauth2_jwt_bearer_1 = require("express-oauth2-jwt-bearer");
const errorHandler_1 = __importDefault(require("./utils/errorHandler"));
const ensureUserExistsMiddleware_1 = __importDefault(
  require("./adapters/express/ensureUserExistsMiddleware")
);
const ensure_user_exists_1 = __importDefault(
  require("./application/use-cases/user/ensure-user-exists")
);
const getEnvVar_1 = require("./utils/getEnvVar");
const services_routes_1 = __importDefault(require("./routes/services-routes"));
const team_member_routes_1 = __importDefault(
  require("./routes/team-member-routes")
);
const team_1 = __importDefault(require("./routes/team"));
const procedure_routes_1 = __importDefault(
...
app.use(jwtCheck);
app.use(
  (0, ensureUserExistsMiddleware_1.default)(ensure_user_exists_1.default)
);
